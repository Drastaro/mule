...
@Entity
@Table(name = "magento_xero_settings")
public class XeroSettings {
	...
	public XeroSettings(String swUserId) {

		this.swUserId = swUserId;
	}

	public XeroSettings(String swUserId, int selectedIncomeAccountId) {

		this.swUserId = swUserId;
		this.selectedIncomeAccountId = selectedIncomeAccountId;
	}

	public XeroSettings(String swUserId, int selectedIncomeAccountId, String magQBTaxesMapping) {
